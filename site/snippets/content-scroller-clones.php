<!-- Wrapper container with mask applied once -->
<div class="projects-clones-mask-container">
    <!-- Clones for images (includes text background clones for mask alignment) -->
    <div class="projects-images-clones-container hidden">
        ...
        <!-- Text background clones (solid background, same mask as images) -->
        <?php 
        if ($projektePages && $projektePages->children()->isNotEmpty()): 
            foreach ($projektePages->children() as $projekt): 
        ?>
            <div class="project-text-background-clone"></div>
        <?php 
            endforeach;
        endif; 
        ?>
